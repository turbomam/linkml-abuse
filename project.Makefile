...
## /Users/MAM/Documents/gitrepos/sheets_and_friends/artifacts/nmdc_submission_schema.yaml
#roundtrip_input = 'https://raw.githubusercontent.com/linkml/linkml-model/main/linkml_model/model/schema/meta.yaml'
#
...
#	$(RUN) python utils/verbatim_sheets.py \
#		--schema_source 'https://raw.githubusercontent.com/linkml/linkml-model/main/linkml_model/model/schema/meta.yaml' \
#		--meta_elements slot_definition \
#		--tsv_output $@
#
...
#	$(RUN) python utils/verbatim_sheets.py.py \
#		--schema_source $(roundtrip_input) \
...
roundtrip_prep:
	rm -rf element_reports
	rm -rf nmdc_reports
	rm -rf slot_definition_reports
	rm -rf verbatim_sheets

#slot_definition_reports/slot_definition_range_tally.tsv: roundtrip_prep
#	$(RUN) python utils/get_metaclass_slotvals.py \
#		--selected_element slot_definition \
#		--directory slot_definition_reports

# https://raw.githubusercontent.com/microbiomedata/nmdc-schema/new_file_enums/src/schema/nmdc.yaml
# https://raw.githubusercontent.com/microbiomedata/nmdc-schema/main/src/schema/nmdc.yaml
# https://raw.githubusercontent.com/linkml/linkml-model/main/linkml_model/model/schema/meta.yaml

nmdc_verbatims/annotations.tsv: roundtrip_prep
	$(RUN) python utils/verbatim_sheets.py \
		--schema_source 'https://raw.githubusercontent.com/linkml/linkml-model/main/linkml_model/model/schema/meta.yaml' \
